...
O canal usa o projeto Supabase `jvqxolwsluvxbmbjmudw` na região `sa-east-1`, com chave pública publishable no cliente. O teste de integração confirmou broadcast entre dois clientes, e os três aliases Vercel públicos entregam o bundle com o lobby `MESA COMPARTILHADA`.
